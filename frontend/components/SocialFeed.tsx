...
export default function SocialFeed() {
  ...
  return (
    <div className="max-w-2xl mx-auto sm:p-4 p-0 space-y-6">
      <Card>
              ...
              <div className="grid grid-cols-2 gap-2">
                {post.images.map((img, i) => (
                  <Image
                    ...
                    src={img}
                    alt="post"
                    width={800} // Giá trị giả định — bạn nên thay bằng chiều rộng mong muốn
                    height={192} // h-48 = 48 * 4 = 192px
                    className="rounded-xl object-cover w-full"
                    style={{ height: "192px" }} // giữ đúng chiều cao như `h-48`
                  />
                ))}
              </div>
            )}
